...
func (r *ReconcileLearn) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil && errors.IsNotFound(err) {
		...
		dep := r.deploymentForLearn(instance)
	...
	listOpts := []client.ListOption{
		...
		client.MatchingLabels(labelsForLearn(instance.Name)),
	}
	if err = r.client.List(context.TODO(), podList, listOpts...); err != nil {
		reqLogger.Error(err, "Failed to list pods", "Learn.Namespace", instance.Namespace, "Learn.Name", instance.Name)
		return reconcile.Result{}, err
	}
